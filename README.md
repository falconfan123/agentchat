...
<p align="center">
  ...
  <a href="https://github.com/falconfan123/agentchat-docs/blob/main/images/README.md">💬 微信群聊</a>
</p>
...
```bash
# 1️⃣ 克隆项目
git clone https://github.com/falconfan123/agentchat.git
cd AgentChat
...
<picture>
  <source
    ...
    srcset="
      https://api.star-history.com/svg?repos=falconfan123/agentchat&type=Date&theme=dark
    "
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="
      https://api.star-history.com/svg?repos=falconfan123/agentchat&type=Date
    "
  />
  <img
    alt="Star History Chart"
    src="https://api.star-history.com/svg?repos=falconfan123/agentchat&type=Date"
  />
</picture>
